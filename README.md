...
#### 8.1 DETALHAMENTO DAS INFORMAÇÕES
        ...
        b) formato .SQL
![Inserção de Dados](https://github.com/SmartVillam/trabalho01/arquivos/topico_8.1.txt?raw=true "Inserção de Dados")
...
#### 8.2 INCLUSÃO DO SCRIPT PARA CRIAÇÃO DE TABELA E INSERÇÃO DOS DADOS
        ...
        c) formato .SQL
![Criação de tabelas + Inserção de Dados](https://github.com/SmartVillam/trabalho01/arquivos/topico_8.2.txt?raw=true "Criação de Tabelas + Inserção de Dados")
